...
"popoto-reset-menu").attr("class","ppt-menu reset").attr("title",a.graph.TOOL_RESET).on("click",a.tools.reset);if(a.taxonomy.isActive&&a.tools.TOGGLE_TAXONOMY)c.append("span").attr("id","popoto-taxonomy-menu").attr("class","ppt-menu taxonomy").attr("title",a.graph.TOOL_TAXONOMY).on("click",a.tools.toggleTaxonomy);if(a.tools.CENTER_GRAPH)c.append("span").attr("id","popoto-center-menu").attr("class","ppt-menu center").attr("title",a.graph.TOOL_CENTER).on("click",a.tools.center);if(a.tools.TOGGLE_FULL_SCREEN)c.append("span").attr("id",
"popoto-fullscreen-menu").attr("class","ppt-menu fullscreen").attr("title",a.graph.TOOL_FULL_SCREEN).on("click",a.tools.toggleFullScreen);b=b.append("svg").call(a.graph.zoom.on("zoom",a.graph.rescale));b.on("dblclick.zoom",null).attr("class","ppt-svg-graph");if(!a.graph.WHEEL_ZOOM_ENABLED)b.on("wheel.zoom",null).on("mousewheel.zoom",null);a.graph.svg=b.append("svg:g");a.graph.svg.append("g").attr("id",a.graph.link.gID);a.graph.svg.append("g").attr("id",a.graph.node.gID);window.addEventListener("resize",
a.graph.centerRootNode)};a.graph.centerRootNode=function(){a.graph.getRootNode().px=a.graph.getSVGWidth()/2;a.graph.getRootNode().py=a.graph.getSVGHeight()/2;a.update()};a.graph.getSVGWidth=function(){return"undefined"==typeof a.graph.svg||a.graph.svg.empty()?(a.logger.debug("popoto.graph.svg is undefined or empty."),0):document.getElementById(a.graph.containerId).clientWidth};a.graph.getSVGHeight=function(){return"undefined"==typeof a.graph.svg||a.graph.svg.empty()?(a.logger.debug("popoto.graph.svg is undefined or empty."),
0):document.getElementById(a.graph.containerId).clientHeight};a.graph.rescale=function(){a.graph.svg.attr("transform","translate("+d3.event.translate+") scale("+d3.event.scale+")")};a.graph.LINK_DISTANCE=150;a.graph.LINK_STRENGTH=1;a.graph.FRICTION=.8;a.graph.CHARGE=-1400;a.graph.THETA=.8;a.graph.GRAVITY=0;a.graph.rootNodeAddListeners=[];a.graph.nodeExpandRelationshipListeners=[];a.graph.createForceLayout=function(){a.graph.force=d3.layout.force().size([a.graph.getSVGWidth(),a.graph.getSVGHeight()]).linkDistance(function(b){return b.type===
a.graph.link.LinkTypes.RELATION?3*a.graph.LINK_DISTANCE/2:a.graph.LINK_DISTANCE}).linkStrength(function(b){return b.linkStrength?b.linkStrength:a.graph.LINK_STRENGTH}).friction(a.graph.FRICTION).charge(function(b){return b.charge?b.charge:a.graph.CHARGE}).theta(a.graph.THETA).gravity(a.graph.GRAVITY).on("tick",a.graph.tick);a.graph.force.drag().on("dragstart",function(a){d3.event.sourceEvent.stopPropagation()}).on("dragend",function(a){d3.event.sourceEvent.stopPropagation()})};a.graph.on=function(b,
c){b===a.graph.Events.NODE_ROOT_ADD&&a.graph.rootNodeAddListeners.push(c);b===a.graph.Events.NODE_EXPAND_RELATIONSHIP&&a.graph.nodeExpandRelationshipListeners.push(c)};a.graph.addRootNode=function(b){0<a.graph.force.nodes().length&&a.logger.warn("popoto.graph.addRootNode is called but the graph is not empty.");a.graph.force.nodes().push({id:"0",type:a.graph.node.NodeTypes.ROOT,x:a.graph.getSVGWidth()/2,y:a.graph.getSVGHeight()/2,label:b,fixed:!0,internalLabel:a.graph.node.generateInternalLabel(b)});
a.graph.rootNodeAddListeners.forEach(function(b){b(a.graph.getRootNode())});a.provider.getIsAutoExpandRelations(b)&&a.graph.node.expandRelationData(a.graph.getRootNode())};a.graph.getRootNode=function(){return a.graph.force.nodes()[0]};a.graph.tick=function(){a.graph.svg.selectAll("#"+a.graph.link.gID+" > g").selectAll("path").attr("d",function(b){var c=a.graph.computeParentAngle(b.target),d=b.target.x+a.graph.link.RADIUS*Math.cos(c),f=b.target.y-a.graph.link.RADIUS*Math.sin(c),e=b.source.x-a.graph.link.RADIUS*
Math.cos(c),c=b.source.y+a.graph.link.RADIUS*Math.sin(c);return b.source.x<=b.target.x?"M"+e+" "+c+"L"+d+" "+f:"M"+d+" "+f+"L"+e+" "+c});a.graph.svg.selectAll("#"+a.graph.node.gID+" > g").attr("transform",function(a){return"translate("+a.x+","+a.y+")"})};a.graph.link={};a.graph.link.RADIUS=25;a.graph.link.gID="popoto-glinks";a.graph.link.LinkTypes=Object.freeze({RELATION:0,VALUE:1});a.graph.link.updateLinks=function(){a.graph.link.svgLinkElements=a.graph.svg.select("#"+a.graph.link.gID).selectAll("g");
a.graph.link.updateData();a.graph.link.removeElements();a.graph.link.addNewElements();a.graph.link.updateElements()};a.graph.link.updateData=function(){a.graph.link.svgLinkElements=a.graph.link.svgLinkElements.data(a.graph.force.links(),function(a){return a.id})};a.graph.link.removeElements=function(){a.graph.link.svgLinkElements.exit().remove()};a.graph.link.addNewElements=function(){var b=a.graph.link.svgLinkElements.enter().append("g").attr("class","ppt-glink").on("mouseover",a.graph.link.mouseOverLink).on("mouseout",
a.graph.link.mouseOutLink);b.append("path");b.append("text").attr("text-anchor","middle").attr("dy","-4").append("textPath").attr("class","ppt-textPath").attr("startOffset","50%")};a.graph.link.updateElements=function(){a.graph.link.svgLinkElements.attr("id",function(a){return"ppt-glink_"+a.id});a.graph.link.svgLinkElements.selectAll("path").attr("id",function(a){return"ppt-path_"+a.id}).attr("class",function(b){return b.type===a.graph.link.LinkTypes.VALUE?"ppt-link-value":0==b.target.count?"ppt-link-relation disabled":
void 0!==b.target.value?"ppt-link-relation value":"ppt-link-relation"});a.graph.link.svgLinkElements.selectAll("text").attr("id",function(a){return"ppt-text_"+a.id}).attr("class",function(b){return b.type===a.graph.link.LinkTypes.VALUE?"ppt-link-text-value":0==b.target.count?"ppt-link-text-relation disabled":void 0!==b.target.value?"ppt-link-text-relation value":"ppt-link-text-relation"}).selectAll(".ppt-textPath").attr("id",function(a){return"ppt-textpath_"+a.id}).attr("xlink:href",function(a){return"#ppt-path_"+
a.id}).text(function(b){return a.provider.getLinkTextValue(b)})};a.graph.link.mouseOverLink=function(){d3.select(this).select("path").classed("ppt-link-hover",!0);d3.select(this).select("text").classed("ppt-link-hover",!0);var b=d3.select(this).data()[0];a.queryviewer.isActive&&(a.queryviewer.queryConstraintSpanElements.filter(function(a){return a.ref===b}).classed("hover",!0),a.queryviewer.querySpanElements.filter(function(a){return a.ref===b}).classed("hover",!0));a.cypherviewer.isActive&&a.cypherviewer.querySpanElements.filter(function(a){return a.link===
b}).classed("hover",!0)};a.graph.link.mouseOutLink=function(){d3.select(this).select("path").classed("ppt-link-hover",!1);d3.select(this).select("text").classed("ppt-link-hover",!1);var b=d3.select(this).data()[0];a.queryviewer.isActive&&(a.queryviewer.queryConstraintSpanElements.filter(function(a){return a.ref===b}).classed("hover",!1),a.queryviewer.querySpanElements.filter(function(a){return a.ref===b}).classed("hover",!1));a.cypherviewer.isActive&&a.cypherviewer.querySpanElements.filter(function(a){return a.link===
b}).classed("hover",!1)};a.graph.node={};a.graph.node.gID="popoto-gnodes";a.graph.node.ELLIPSE_RX=50;a.graph.node.ELLIPSE_RY=25;a.graph.node.TEXT_Y=8;a.graph.node.BACK_CIRCLE_R=70;a.graph.node.NODE_MAX_CHARS=11;a.graph.node.PAGE_SIZE=10;a.graph.node.CountBox={x:16,y:33,w:52,h:19};a.graph.node.chooseWaiting=!1;a.graph.node.NodeTypes=Object.freeze({ROOT:0,CHOOSE:1,VALUE:2,GROUP:3});a.graph.node.idgen=0;a.graph.node.internalLabels={};a.graph.node.generateInternalLabel=function(b){b=b?b.toLowerCase().replace(/ /g,
""):"n";if(b in a.graph.node.internalLabels)a.graph.node.internalLabels[b]+=1;else return a.graph.node.internalLabels[b]=0,b;return b+a.graph.node.internalLabels[b]};a.graph.node.updateNodes=function(){a.graph.node.svgNodeElements||(a.graph.node.svgNodeElements=a.graph.svg.select("#"+a.graph.node.gID).selectAll("g"));a.graph.node.updateData();a.graph.node.removeElements();a.graph.node.addNewElements();a.graph.node.updateElements()};a.graph.node.updateData=function(){a.graph.node.svgNodeElements=a.graph.node.svgNodeElements.data(a.graph.force.nodes(),
function(a){return a.id});a.graph.hasGraphChanged&&(a.graph.node.updateCount(),a.graph.hasGraphChanged=!1)};a.graph.node.updateCount=function(){var b=[],c=a.graph.force.nodes().filter(function(b){return a.graph.node.NodeTypes.VALUE!==b.type&&a.graph.node.NodeTypes.GROUP!==b.type});c.forEach(function(c){c=a.query.generateNodeCountQuery(c);b.push({statement:c.statement,parameters:c.parameters})});a.logger.info("Count nodes ==> ");a.rest.post({statements:b}).done(function(b){if(b){b.hasOwnProperty("errors")&&
0<b.errors.length&&a.logger.error("Cypher query error:"+JSON.stringify(b.errors));if(b.hasOwnProperty("results")&&0<b.results.length)for(var f=0;f<c.length;f++)c[f].count=b.results[f].data[0].row[0];else c.forEach(function(a){a.count=0});0<a.result.resultCountListeners.length&&a.result.updateResultsCount();a.graph.node.updateElements();a.graph.link.updateElements()}}).fail(function(b,f,e){a.logger.error(f+': error while accessing Neo4j server on URL:"'+a.rest.CYPHER_URL+'" defined in "popoto.rest.CYPHER_URL" property: '+
e);c.forEach(function(a){a.count=0});a.graph.node.updateElements();a.graph.link.updateElements()})};a.graph.node.removeElements=function(){var b=a.graph.node.svgNodeElements.exit();b.filter(function(a){return!a.parent}).remove();b.filter(function(a){return a.parent}).transition().duration(300).attr("transform",function(a){return"translate("+a.parent.x+","+a.parent.y+")"}).remove()};a.graph.node.addNewElements=function(){var b=a.graph.node.svgNodeElements.enter().append("g").on("click",a.graph.node.nodeClick).on("mouseover",
a.graph.node.mouseOverNode).on("mouseout",a.graph.node.mouseOutNode);b.filter(function(b){return b.type!==a.graph.node.NodeTypes.VALUE}).on("contextmenu",a.graph.node.clearSelection);b.filter(function(b){return b.type===a.graph.node.NodeTypes.VALUE}).on("contextmenu",function(){d3.event.preventDefault()});b.append("title").attr("class","ppt-svg-title");a.graph.node.addBackgroundElements(b);a.graph.node.addMiddlegroundElements(b);a.graph.node.addForegroundElements(b)};a.graph.node.addBackgroundElements=
function(b){b.append("g").attr("class","ppt-g-node-background").append("circle").attr("class",function(b){var d="ppt-node-background-circle";void 0!==b.value?d+=" selected-value":b.type===a.graph.node.NodeTypes.ROOT?d+=" root":b.type===a.graph.node.NodeTypes.CHOOSE?d+=" choose":b.type===a.graph.node.NodeTypes.VALUE?d+=" value":b.type===a.graph.node.NodeTypes.GROUP&&(d+=" group");return d}).style("fill-opacity",0).attr("r",a.graph.node.BACK_CIRCLE_R)};a.graph.node.addMiddlegroundElements=function(a){a.append("g").attr("class",
"ppt-g-node-middleground")};a.graph.node.addForegroundElements=function(b){b=b.append("g").attr("class","ppt-g-node-foreground");var c=b.filter(function(b){return b.type!==a.graph.node.NodeTypes.VALUE}).append("g").attr("class","ppt-rel-plus-icon");c.append("title").text("Add relationship");c.append("circle").attr("class","ppt-rel-plus-background").attr("cx","32").attr("cy","-43").attr("r","16");c.append("path").attr("class","ppt-rel-plus-path").attr("d","M 40,-45 35,-45 35,-50 30,-50 30,-45 25,-45 25,-40 30,-40 30,-35 35,-35 35,-40 40,-40 z");
c.on("mouseover",function(){d3.select(this).select(".ppt-rel-plus-background").transition().style("fill-opacity",.5)}).on("mouseout",function(){d3.select(this).select(".ppt-rel-plus-background").transition().style("fill-opacity",0)}).on("click",function(){d3.event.stopPropagation();a.graph.node.expandRelationship.call(this)});c=b.filter(function(b){return b.type!==a.graph.node.NodeTypes.VALUE}).append("g").attr("class","ppt-rel-minus-icon");c.append("title").text("Remove relationship");c.append("circle").attr("class",
"ppt-rel-minus-background").attr("cx","32").attr("cy","-43").attr("r","16");c.append("path").attr("class","ppt-rel-minus-path").attr("d","M 40,-45 25,-45 25,-40 40,-40 z");c.on("mouseover",function(){d3.select(this).select(".ppt-rel-minus-background").transition().style("fill-opacity",.5)}).on("mouseout",function(){d3.select(this).select(".ppt-rel-minus-background").transition().style("fill-opacity",0)}).on("click",function(){d3.event.stopPropagation();a.graph.node.collapseRelationship.call(this)});
...
function(){a.graph.node.svgNodeElements.selectAll(".ppt-g-node-background").selectAll(".ppt-node-background-circle").attr("class",function(b){var c="ppt-node-background-circle";b.type===a.graph.node.NodeTypes.VALUE?c+=" value":b.type===a.graph.node.NodeTypes.GROUP?c+=" group":void 0!==b.value?b.type===a.graph.node.NodeTypes.ROOT?c+=" selected-root-value":b.type===a.graph.node.NodeTypes.CHOOSE&&(c+=" selected-value"):0==b.count?c+=" disabled":b.type===a.graph.node.NodeTypes.ROOT?c+=" root":b.type===
a.graph.node.NodeTypes.CHOOSE&&(c+=" choose");return c}).attr("r",a.graph.node.BACK_CIRCLE_R)};a.graph.node.updateMiddlegroundElements=function(){var b=a.graph.node.svgNodeElements.selectAll(".ppt-g-node-middleground");b.selectAll("*").remove();b.filter(function(b){return a.provider.getNodeDisplayType(b)===a.provider.NodeDisplayTypes.IMAGE}).append("image").attr("class","ppt-node-image").attr("width",function(b){return a.provider.getImageWidth(b)}).attr("height",function(b){return a.provider.getImageHeight(b)}).attr("transform",
...
!1;a.logger.error(c+': error while accessing Neo4j server on URL:"'+a.rest.CYPHER_URL+'" defined in "popoto.rest.CYPHER_URL" property: '+e)})}};a.graph.node.parseResultData=function(a){var c=[];if(a&&a.hasOwnProperty("results")&&0<a.results.length)for(var d=0;d<a.results[0].data.length;d++){for(var f={},e=0;e<a.results[0].columns.length;e++)f[a.results[0].columns[e]]=a.results[0].data[d].row[e];c.push(f)}return c};a.graph.computeParentAngle=function(a){var c=0;if(a.parent){var c=a.parent.x,d=a.parent.y,
f=a.x;a=a.y;var e=100/(Math.sqrt(Math.pow(c-f,2)+Math.pow(d-a,2))-100),c=((f+e*c)/(1+e)-f)/100;-1>c&&(c=-1);1<c&&(c=1);c=Math.acos(c);d>a&&(c=2*Math.PI-c)}return c};a.graph.node.expandNode=function(b){var c=b.page*a.graph.node.PAGE_SIZE,d=b.data.slice(c-a.graph.node.PAGE_SIZE,c),f=a.graph.computeParentAngle(b),e=1;d.forEach(function(c){var h;h=b.parent?360/(d.length+1)*e:360/d.length*e;var k=b.x+100*Math.cos(Math.PI/180*h-f);h=b.y+100*Math.sin(Math.PI/180*h-f);c={id:++a.graph.node.idgen,parent:b,
attributes:c,type:a.graph.node.NodeTypes.VALUE,label:b.label,count:c.count,x:k,y:h,internalID:c[a.query.NEO4J_INTERNAL_ID.queryInternalName]};a.graph.force.nodes().push(c);a.graph.force.links().push({id:"l"+ ++a.graph.node.idgen,source:b,target:c,type:a.graph.link.LinkTypes.VALUE});e++});b.fixed=!0;b.parent&&b.parent.type!==a.graph.node.NodeTypes.ROOT&&(b.parent.fixed=!0);b.valueExpanded=!0;a.update()};a.graph.node.expandRelationship=function(){d3.event.preventDefault();a.graph.nodeExpandRelationshipListeners.forEach(function(a){a(this)});
...
b.forEach(function(b){var c=b.source,h=b.target;b.type===a.graph.link.LinkTypes.RELATION&&h.type!==a.graph.node.NodeTypes.GROUP&&h.value&&(c.type===a.graph.node.NodeTypes.GROUP&&d.push({id:f++,type:c.type,term:a.provider.getSemanticValue(c),ref:c}),d.push({id:f++,isLink:!0,term:a.provider.getLinkSemanticValue(b),ref:b}),h.type!==a.graph.node.NodeTypes.GROUP&&(h.value?d.push({id:f++,type:h.type,term:a.provider.getSemanticValue(h),ref:h}):d.push({id:f++,type:h.type,term:"<"+a.queryviewer.CHOOSE_LABEL+
" "+a.provider.getSemanticValue(h)+">",ref:h})))});return d};a.queryviewer.generateData=function(b,c){var d=[],f=[],e=0;b.forEach(function(b){var c=b.source,k=b.target;k.type===a.graph.node.NodeTypes.GROUP&&f.push({id:e++,type:k.type,term:a.provider.getSemanticValue(k),ref:k});b.type!==a.graph.link.LinkTypes.RELATION||k.type===a.graph.node.NodeTypes.GROUP||k.value||(c.type===a.graph.node.NodeTypes.GROUP&&d.push({id:e++,type:c.type,term:a.provider.getSemanticValue(c),ref:c}),d.push({id:e++,isLink:!0,
term:a.provider.getLinkSemanticValue(b),ref:b}),k.type!==a.graph.node.NodeTypes.GROUP&&(k.value?d.push({id:e++,type:k.type,term:a.provider.getSemanticValue(k),ref:k}):d.push({id:e++,type:k.type,term:"<"+a.queryviewer.CHOOSE_LABEL+" "+a.provider.getSemanticValue(k)+">",ref:k})))});return d.concat(f)};a.queryviewer.mouseOverSpan=function(){d3.select(this).classed("hover",function(a){return a.ref});var b=d3.select(this).data()[0];if(b.ref){var c=a.graph.svg.selectAll("#"+a.graph.link.gID+" > g").filter(function(a){return a===
...
":`"+m.label+"`)")});return{matchElements:e,whereElements:g,relationElements:h,parameters:k}};a.query.getRelevantLinks=function(a,c,d){var f=d.slice(),e=[],g=[];f.forEach(function(a){(a.target.value||a.target===c)&&e.push(a)});e.forEach(function(a){f.splice(f.indexOf(a),1)});e.forEach(function(c){var d=c.source;for(c=!0;c;){var e=null;f.forEach(function(a){a.target===d&&(e=a)});null===e?c=!1:e.source===a?(g.push(e),f.splice(f.indexOf(e),1),c=!1):(g.push(e),f.splice(f.indexOf(e),1),d=e.source)}});
...
a.result.onGraphResultReceived=function(b){a.result.graphResultListeners.push(b)};a.result.parseResultData=function(b){var c=[];if(b&&b.hasOwnProperty("results")&&0<b.results.length)for(var d=0;d<b.results[0].data.length;d++){for(var f={resultIndex:d,label:a.graph.getRootNode().label,attributes:{}},e=0;e<b.results[0].columns.length;e++)f.attributes[b.results[0].columns[e]]=""+b.results[0].data[d].row[e];c.push(f)}return c};a.result.parseGraphResultData=function(a){var c={},d={};a.results[1].data.forEach(function(a){a.graph.nodes.forEach(function(a){c.hasOwnProperty(a.id)||
(c[a.id]=a)});a.graph.relationships.forEach(function(a){d.hasOwnProperty(a.id)||(d[a.id]=a)})});a=[];var f=[],e;for(e in c)c.hasOwnProperty(e)&&a.push(c[e]);for(var g in d)d.hasOwnProperty(g)&&f.push(d[g]);return{nodes:a,edges:f}};a.result.updateResults=function(){if(a.result.hasChanged){var b=a.query.generateResultQuery(),b={statements:[{statement:b.statement,parameters:b.parameters,resultDataContents:["row"]}]};if(0<a.result.graphResultListeners.length){var c=a.query.generateResultQuery(!0);b.statements.push({statement:c.statement,
parameters:c.parameters,resultDataContents:["graph"]})}a.logger.info("Results ==> ");a.rest.post(b).done(function(b){b.errors&&0<b.errors.length&&a.logger.error("Cypher query error:"+JSON.stringify(b.errors));var c=a.result.parseResultData(b);a.result.resultListeners.forEach(function(a){a(c)});if(0<a.result.graphResultListeners.length){var e=a.result.parseGraphResultData(b);a.result.graphResultListeners.forEach(function(a){a(e)})}a.result.isActive&&(b=d3.select("#"+a.result.containerId).selectAll(".ppt-result").data([]),
...
b+"), default value will be used"),a.provider.DEFAULT_PROVIDER.hasOwnProperty(c)?d[c]=a.provider.DEFAULT_PROVIDER[c]:a.logger.error('No default value for "'+c+'" property found for label provider ('+b+")"))}return d[c]};a.provider.getIsSearchable=function(b){return a.provider.getProperty(b,"isSearchable")};a.provider.getIsAutoExpandRelations=function(b){return a.provider.getProperty(b,"autoExpandRelations")};a.provider.getReturnAttributes=function(b){var c=a.provider.getProvider(b),d={};if(c.hasOwnProperty("returnAttributes"))for(var f=
0;f<c.returnAttributes.length;f++)c.returnAttributes[f]===a.query.NEO4J_INTERNAL_ID?d[a.query.NEO4J_INTERNAL_ID.queryInternalName]=!0:d[c.returnAttributes[f]]=!0;for(;c.hasOwnProperty("parent");)if(c=a.provider.getProvider(c.parent),c.hasOwnProperty("returnAttributes"))for(f=0;f<c.returnAttributes.length;f++)c.returnAttributes[f]===a.query.NEO4J_INTERNAL_ID?d[a.query.NEO4J_INTERNAL_ID.queryInternalName]=!0:d[c.returnAttributes[f]]=!0;if(a.provider.DEFAULT_PROVIDER.hasOwnProperty("returnAttributes"))for(c=
0;c<a.provider.DEFAULT_PROVIDER.returnAttributes.length;c++)a.provider.DEFAULT_PROVIDER.returnAttributes[c]!==a.query.NEO4J_INTERNAL_ID&&(d[a.provider.DEFAULT_PROVIDER.returnAttributes[c]]=!0);b=a.provider.getConstraintAttribute(b);b===a.query.NEO4J_INTERNAL_ID?d[a.query.NEO4J_INTERNAL_ID.queryInternalName]=!0:d[b]=!0;b=[];for(var e in d)d.hasOwnProperty(e)&&(e==a.query.NEO4J_INTERNAL_ID.queryInternalName?b.push(a.query.NEO4J_INTERNAL_ID):b.push(e));0>=b.length&&b.push(a.query.NEO4J_INTERNAL_ID);
return b};a.provider.getConstraintAttribute=function(b){return a.provider.getProperty(b,"constraintAttribute")};a.provider.getPredefinedConstraints=function(b){return a.provider.getProperty(b,"getPredefinedConstraints")()};a.provider.filterResultQuery=function(b,c){return a.provider.getProperty(b,"filterResultQuery")(c)};a.provider.getValueOrderByAttribute=function(b){return a.provider.getProperty(b,"valueOrderByAttribute")};a.provider.isValueOrderAscending=function(b){return a.provider.getProperty(b,
"isValueOrderAscending")};a.provider.getResultOrderByAttribute=function(b){return a.provider.getProperty(b,"resultOrderByAttribute")};a.provider.isResultOrderAscending=function(b){return a.provider.getProperty(b,"isResultOrderAscending")};a.provider.getTextValue=function(b){return a.provider.getProperty(b.label,"getTextValue")(b)};a.provider.getTextValue=function(b){return a.provider.getProperty(b.label,"getTextValue")(b)};a.provider.getSemanticValue=function(b){return a.provider.getProperty(b.label,
"getSemanticValue")(b)};a.provider.getSVGPaths=function(b){return a.provider.getProperty(b.label,"getSVGPaths")(b)};a.provider.isTextDisplayed=function(b){return a.provider.getProperty(b.label,"getIsTextDisplayed")(b)};a.provider.getIsGroup=function(b){return a.provider.getProperty(b.label,"getIsGroup")(b)};a.provider.getNodeDisplayType=function(b){return a.provider.getProperty(b.label,"getDisplayType")(b)};a.provider.getImagePath=function(b){return a.provider.getProperty(b.label,"getImagePath")(b)};
a.provider.getImageWidth=function(b){return a.provider.getProperty(b.label,"getImageWidth")(b)};a.provider.getImageHeight=function(b){return a.provider.getProperty(b.label,"getImageHeight")(b)};a.provider.filterNodeValueQuery=function(b,c){return a.provider.getProperty(b.label,"filterNodeValueQuery")(b,c)};a.provider.filterNodeCountQuery=function(b,c){return a.provider.getProperty(b.label,"filterNodeCountQuery")(b,c)};a.provider.filterNodeRelationQuery=function(b,c){return a.provider.getProperty(b.label,
"filterNodeRelationQuery")(b,c)};a.provider.getDisplayResultFunction=function(b){return a.provider.getProperty(b,"displayResults")};a.provider.DEFAULT_PROVIDER=Object.freeze({isSearchable:!0,autoExpandRelations:!1,returnAttributes:[a.query.NEO4J_INTERNAL_ID],valueOrderByAttribute:"count",isValueOrderAscending:!1,resultOrderByAttribute:null,isResultOrderAscending:!0,constraintAttribute:a.query.NEO4J_INTERNAL_ID,getPredefinedConstraints:function(){return[]},filterResultQuery:function(a){return a},getDisplayType:function(b){return a.provider.NodeDisplayTypes.TEXT},
getIsGroup:function(a){return!1},getIsTextDisplayed:function(a){return!0},getTextValue:function(b){var c=a.provider.getProperty(b.label,"constraintAttribute");return(b.type===a.graph.node.NodeTypes.VALUE?c===a.query.NEO4J_INTERNAL_ID?""+b.internalID:""+b.attributes[c]:void 0===b.value?b.label:c===a.query.NEO4J_INTERNAL_ID?""+b.value.internalID:""+b.value.attributes[c]).substring(0,a.graph.node.NODE_MAX_CHARS)},getSemanticValue:function(b){var c=a.provider.getProperty(b.label,"constraintAttribute");
return b.type===a.graph.node.NodeTypes.VALUE?c===a.query.NEO4J_INTERNAL_ID?""+b.internalID:""+b.attributes[c]:void 0===b.value?b.label:c===a.query.NEO4J_INTERNAL_ID?""+b.value.internalID:""+b.value.attributes[c]},getImagePath:function(b){if(b.type===a.graph.node.NodeTypes.VALUE)return"css/image/node-yellow.png";if(void 0===b.value){if(b.type===a.graph.node.NodeTypes.ROOT)return"css/image/node-blue.png";if(b.type===a.graph.node.NodeTypes.CHOOSE)return"css/image/node-green.png";if(b.type===a.graph.node.NodeTypes.GROUP)return"css/image/node-black.png"}else return"css/image/node-orange.png"},
getImageWidth:function(a){return 125},getImageHeight:function(a){return 125},filterNodeValueQuery:function(a,c){return c},filterNodeCountQuery:function(a,c){return c},filterNodeRelationQuery:function(a,c){return c},displayResults:function(b){var c=b.data()[0],d=a.provider.getReturnAttributes(c.label),f=b.append("table").attr("class","ppt-result-table");d.forEach(function(b){var d=b===a.query.NEO4J_INTERNAL_ID?a.query.NEO4J_INTERNAL_ID.queryInternalName:b,h=f.append("tr");h.append("th").text(function(){return b===
a.query.NEO4J_INTERNAL_ID?"internal ID:":b+":"});void 0!==c.attributes[d]&&h.append("td").text(function(a){return a.attributes[d]})})}});return a}();
